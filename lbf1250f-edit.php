                    ...
                    <div class="card-body">
                        ...
                        <form action="lbf1250f-code.php" method="POST">
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col">
                                    <label>Unit</label>                                    
                                    <select name="lbf1250f_unit_i" value="<?=$lbf1250f['lbf1250f_unit_i'];?>" class="form-control">
                            ...
                            <div class="row g-1 mb-3">
                                ...
                                <div class="col">
                                    <label>Unit</label>                                                                       
                                    <select name="lbf1250f_uniti_r" value="<?=$lbf1250f['lbf1250f_uniti_r'];?>" class="form-control">
                                    <option value="pcs.">pcs.</option>
                                    <option value="kg.">kg.</option>
                                    <option value="spool.">spool.</option>
                                    <!-- เพิ่มตัวเลือกเพิ่มเติมตามที่คุณต้องการ -->
                            ...
                            <div class="mb-3">
                                <label>Status</label>                                
                                <select name="lbf1250f_status" value="<?=$lbf1250f['lbf1250f_status'];?>" class="form-control">                                    
