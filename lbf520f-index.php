...
<head>
    ...
    <title>Label Front 520ml. - CCL</title>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                ...
                                <?php
                    $query = "SELECT SUM(lbf520f_quantity_r) as total_quantity FROM lbf520f WHERE lbf520f_status = 'QC Passed'";
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Remaining</div>
                                <?php
                            $query = "SELECT SUM(lbf520f_quantity_r) as total_quantity1 FROM lbf520f WHERE lbf520f_status = 'Returned'";
                            $query_run = mysqli_query($con, $query);
                            if ($query_run) {
                                $row = mysqli_fetch_assoc($query_run);
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                ...
                                <?php
                            $query = "SELECT SUM(lbf520f_quantity_r) as total_quantity2 FROM lbf520f WHERE lbf520f_status = 'Waiting for Destroy'";
                            $query_run = mysqli_query($con, $query);
                            if ($query_run) {
                                $row = mysqli_fetch_assoc($query_run);
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                ...
                                <?php
                            $query = "SELECT SUM(lbf520f_quantity_r) as total_quantity3 FROM lbf520f WHERE lbf520f_status = 'Waiting for Return'";
                            $query_run = mysqli_query($con, $query);
                            if ($query_run) {
                                $row = mysqli_fetch_assoc($query_run);
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                ...
                                <?php
                            $query = "SELECT SUM(lbf520f_quantity_r) as total_quantity4 FROM lbf520f WHERE lbf520f_status = 'Waiting for Inspection'";
                            $query_run = mysqli_query($con, $query);
                            if ($query_run) {
                                $row = mysqli_fetch_assoc($query_run);
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-9">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Total</div>
                                <?php
    $query = "SELECT SUM(lbf520f_quantity_r) as total_quantity FROM lbf520f";
    $query_run = mysqli_query($con, $query);
    if ($query_run) {
        $row = mysqli_fetch_assoc($query_run);
        $total_quantity = $row['total_quantity'];
                        ...
                        <tbody>
                            <?php 
                                    ...
                                    if(mysqli_num_rows($query_run) > 0)
                                    {
                                        ...
                                        {
                                            ?>
                            <tr <?php if ($lbf520f['lbf520f_status'] == 'Waiting for Inspection') echo 'class="Inspection"'; ?>
                                <?php if ($lbf520f['lbf520f_status'] == 'Waiting for Destroy') echo 'class="Destroy"'; ?>
                                <?php if ($lbf520f['lbf520f_status'] == 'QC Passed') echo 'class="Passed"'; ?>
                                <?php if ($lbf520f['lbf520f_status'] == 'Returned') echo 'class="Returned"'; ?>
                                <?php if ($lbf520f['lbf520f_status'] == 'Waiting for Return') echo 'class="Return"'; ?>
                                ...
                                <td><?= date('d-m-Y', strtotime($lbf520f['lbf520f_md'])); ?></td>
                                <td><?= date('d-m-Y', strtotime($lbf520f['lbf520f_rd'])); ?></td>
