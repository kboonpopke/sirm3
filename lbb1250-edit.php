                    ...
                    <div class="card-body">
                        ...
                        <form action="lbb1250-code.php" method="POST">
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col">
                                    <label>Unit</label>                                    
                                    <select name="lbb1250_unit_i" value="<?=$lbb1250['lbb1250_unit_i'];?>" class="form-control">
                            ...
                            <div class="row g-1 mb-3">
                                ...
                                <div class="col">
                                    <label>Unit</label>                                                                       
                                    <select name="lbb1250_uniti_r" value="<?=$lbb1250['lbb1250_uniti_r'];?>" class="form-control">
                                    <option value="pcs.">pcs.</option>
                                    <option value="kg.">kg.</option>
                                    <option value="spool.">spool.</option>
                                    <!-- เพิ่มตัวเลือกเพิ่มเติมตามที่คุณต้องการ -->
                            ...
                            <div class="mb-3">
                                <label>Status</label>                                
                                <select name="lbb1250_status" value="<?=$lbb1250['lbb1250_status'];?>" class="form-control">                                    
