                    ...
                    <div class="card-body">
                        ...
                        <form action="shf520p-code.php" method="POST">
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col">
                                    <label>Unit</label>                                    
                                    <select name="shf520p_unit_i" value="<?=$shf520p['shf520p_unit_i'];?>" class="form-control">
                            ...
                            <div class="row g-1 mb-3">
                                ...
                                <div class="col">
                                    <label>Unit</label>                                                                       
                                    <select name="shf520p_uniti_r" value="<?=$shf520p['shf520p_uniti_r'];?>" class="form-control">
                                    <option value="pcs.">pcs.</option>
                                    <option value="kg.">kg.</option>
                                    <option value="spool.">spool.</option>
                                    <!-- เพิ่มตัวเลือกเพิ่มเติมตามที่คุณต้องการ -->
                            ...
                            <div class="mb-3">
                                <label>Status</label>                                
                                <select name="shf520p_status" value="<?=$shf520p['shf520p_status'];?>" class="form-control">                                    
